...
('Pez molly negro','Poecilia sphenops','Este popular pez ornamental es la versión negra del pez molly común que habita en América del Sur y América Central',2,58,20.43,'image/pet/molly.png'),
('Gato británico','British Shorthair','Es una raza relativamente grande que podría describirse como gruesa o fornida. Tiene muchos contornos redondeados: la cara y las mejillas, las orejas, los ojos y la cabeza',4,30,120.43,'image/pet/british.png');
...
VALUES('Camiseta gato feliz','Una camiseta que te alegrará el día a ti y a todo el que te cruces',20,15.25,'image/merch/gatofeliz.png'),
('Gorra pajaro','Esta gorra más que parar el sol te dará alas',20,8.00,'image/merch/gorrapajaro.png'),
('Camiseta OnlyZoo','Camiseta blanca con nuestro logo en colaboración con Versace',100, 211.30,'image/merch/camionlyzoo.png'),
('Figura agallas','Muñeco del icónico personaje de cartoon network',5,10.32,'image/merch/agallas.png'),
('Taza perro','Una graciosa taza con forma de perrete',10,5.10,'image/merch/tazaperro.png'),
...
VALUES('Saco de comida para pájaros','20 kilos de sabrosura para tus aves',1,5,35.99,'image/product/sacoave.png'),
('Pienso para perros famélicos','30 kilos de sabrosura para tus perros flacos',3,55,58.99,'image/product/sacoperro.png'),
('Croquetas para felinos esterilizados','20 kilos de sabrosura para gatitos capados',4,100,12.99,'image/product/sacogato.png'),
('Correa estranguladora','ahorca a tu mascota con estilo',3,20,23.43,'image/product/correa.png'),
('Juguete para gatos','juega con tu gato con este plumero super fantastico',4,78,5.99,'image/product/juguete.png'),
('Planta para acuario','Amenízale la existencia a tu infeliz pescado con esta platita',2,45,13.23,'image/product/planta.png'),
('Saquito comida pez','Rico alimento para peces y pececitos',2,45,22.23,'image/product/sacopez.png');
